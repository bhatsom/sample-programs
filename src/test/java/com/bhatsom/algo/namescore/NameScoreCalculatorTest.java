...
public class NameScoreCalculatorTest {
	...
	public void testCalculateNameScore() throws Exception {
		...
		assertEquals(227, NameScoreCalculator.calculateNameScore("names.txt", scoringAlgo));

		// now run the actual assignment file
		assertEquals(871198282, NameScoreCalculator.calculateNameScore("OCC-Take-Home-Coding-names.txt", scoringAlgo));
	}
}